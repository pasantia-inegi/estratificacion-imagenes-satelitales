...
**Repetir el proceso con datos nuevos (este año)**
...
Uniendo EPF y CASEN tenemos aproximadamente `r total_upm`


- Extrar características de imágenes nuevas
- Entrenar
- Actualizar app
...
**Automatizar descarga via API GEE-Python (octubre)**

--

**Mejorar la extracción de características (octubre)**

--

**Estudiar algunas opciones para mejorar el entrenamiento (octubre-noviembre)**

--

**Predicciones para todo el Gran Santiago (diciembre)**
...
**Generación de productos (enero-febrero-marzo)**

- Publicación de aplicación de uso interna
- Documentación
- Presentación institucional sobre la experiencia (marzo)

--

**Nuevas aplicaciones y exploraciones (2024)**

- Extensión estratificación al resto del país
- Detección de asentamientos urbanos
- Detección de cambios importantes en UPMs
